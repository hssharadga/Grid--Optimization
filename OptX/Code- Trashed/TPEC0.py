...
src_data = r'C:\Users\hussein.sharadga\Desktop\OptX\grids\C3E3.1D1_20240606\E3.1\D1\C3E3N04224D1\scenario_132.json'
...
if n_b<5000:
    ...
    # Model
    m=gp.Model()
    # m.setParam('Threads', 112)  # Set to the number of threads you want to use
...
#             m.addConstr(float(pj0[j])<=pj_min_[j,0]+(1-j_sd[j,0])*GRB.INFINITY)
    ...
    time0=stop - start
    print('Time [mins]- gurobi',time0/60)
...
#         # if stage==1 and (Seq_2!=1 or div==1): # no need for two-time SW for Mod Seq-Ipopt (Seq_2=2) and One-step Ipopt (Seq_2=0)
#         #     continue
#         # Model
#         m=gp.Model()
#         m.setParam('Threads', 112)  # Set to the number of threads you want to use
...
#         # if div==1 and Seq_2!=1:
#         #     m.Params.TIME_LIMIT = 60*3
#         # elif (div==1 and Seq_2==1):
#         #     m.Params.TIME_LIMIT = 60*1.5
        
#         # if div==1:
#         #     m.Params.TIME_LIMIT = 60*3
#         #     if n_b>=20000:
#         #         m.Params.TIME_LIMIT = 60*2
#         # elif div==2:
#         #     m.Params.TIME_LIMIT = 60*10
#         # else:
#         #     m.Params.TIME_LIMIT = 60*10
