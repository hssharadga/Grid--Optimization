# -*- coding: utf-8 -*-
"""
Created on Sun Apr 13 04:00:46 2025
...
s_plus = m.addVars(n_f, n_t, vtype=COPT.CONTINUOUS, lb=0, ub=1000)
BIG=1e6
zen = m.addVars(n_j, n_t, vtype=COPT.CONTINUOUS, lb=-BIG, ub=BIG)
...
Zp=m.addVar(vtype='C', lb=0, ub=10000000) # Cost function
...
Zs=m.addVar(vtype='C', lb=0, ub=10000000) # Cost function
