# -*- coding: utf-8 -*-
"""
Created on Mon Mar 10 03:15:29 2025
...
# Data preparation
data = {
    "Switch": ["Single"] * 6 + ["Multiple"] * 6,
    "Time [mins]": [1.217, 1.101, 1.325, 1.293, 1.261, 1.184, 
                     0.796, 0.777, 1.034, 1.161, 1.092, 
                    2.645]
}
...
data = {
    "Switch": ["Single"] * 6 + ["Multiple"] * 6,
    "Time [mins]": [2.716, 3.17, 1.186, 1.498, 1.401, 1.524, 
                    0.955, 0.989, 1.181, 1.023, 0.94, 1.224]
}
...
# Data preparation
data = {
    "Constraints": ["Tight"] * 6 + ["Original"] * 6,
    "Time [mins]": [1.156, 1.122, 1.151, 1.116, 1.149, 1.358, 
...
# Data preparation
data = {
    "Constraints": ["Lazy"] * 6 + ["Original"] * 6,
    "Time [mins]": [0.867, 0.712, 0.528, 0.674, 0.651, 0.527, 
                    1.217, 1.101, 1.325, 1.293, 1.261, 1.184]
}
